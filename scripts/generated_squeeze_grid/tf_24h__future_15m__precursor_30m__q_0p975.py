...
OUTPUT_DIR = Path(
    "data/research/topology_v2_squeeze_grid/tf_24h__future_15m__precursor_30m__q_0p975"
)
...
TOPOLOGY_TIMEFRAME = "24h"

# Olay tanımı.
FUTURE_WINDOW = pd.Timedelta(minutes=15)
PRECURSOR_OFFSET = pd.Timedelta(minutes=30)
