...
echo
echo "=========================================="
echo "XAG V5 — 60 Günlük Nearest-Pool Testi"
echo "=========================================="

python src/validate_nearest_pool_v5.py \
  2>&1 | tee logs/xag_validate_nearest_pool_v5.log

echo
echo "=========================================="
echo "XAG V6 — Distance × Volume Matrix"
echo "=========================================="

python src/analyze_edge_matrix_v6.py \
  2>&1 | tee logs/xag_analyze_edge_matrix_v6.log

echo
echo "=========================================="
echo "XAG 60 Günlük Araştırma Tamamlandı"
echo "=========================================="
...
v5_path = Path("reports/xagusdt_60d_nearest_pool_v5.json")
v6_path = Path("reports/xagusdt_60d_edge_matrix_v6.json")
